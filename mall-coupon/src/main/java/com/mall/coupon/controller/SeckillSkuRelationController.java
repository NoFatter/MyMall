...
import com.mall.coupon.excel.SeckillSkuRelationExcel;
...
public class SeckillSkuRelationController {
    ...
    @RequiresPermissions("seckillskurelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("seckillskurelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("seckillskurelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("seckillskurelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("seckillskurelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("seckillskurelation:export")
