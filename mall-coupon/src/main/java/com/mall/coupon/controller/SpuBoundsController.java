...
import com.mall.coupon.dto.SpuBoundsDTO;
import com.mall.coupon.excel.SpuBoundsExcel;
...
public class SpuBoundsController {
    ...
    @RequiresPermissions("spubounds:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("spubounds:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("spubounds:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("spubounds:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("spubounds:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("spubounds:export")
