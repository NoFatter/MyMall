...
import com.mall.coupon.excel.CouponSpuRelationExcel;
...
public class CouponSpuRelationController {
    ...
    @RequiresPermissions("couponspurelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("couponspurelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("couponspurelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("couponspurelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("couponspurelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("couponspurelation:export")
