...
import com.mall.coupon.dto.CouponSpuCategoryRelationDTO;
import com.mall.coupon.excel.CouponSpuCategoryRelationExcel;
...
public class CouponSpuCategoryRelationController {
    ...
    @RequiresPermissions("couponspucategoryrelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("couponspucategoryrelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("couponspucategoryrelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("couponspucategoryrelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("couponspucategoryrelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("couponspucategoryrelation:export")
