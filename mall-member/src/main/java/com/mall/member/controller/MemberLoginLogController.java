...
import com.mall.member.dto.MemberLoginLogDTO;
import com.mall.member.excel.MemberLoginLogExcel;
...
public class MemberLoginLogController {
    ...
    @RequiresPermissions("memberloginlog:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("memberloginlog:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("memberloginlog:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("memberloginlog:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("memberloginlog:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("memberloginlog:export")
