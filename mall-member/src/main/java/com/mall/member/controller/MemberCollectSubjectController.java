...
import com.mall.member.dto.MemberCollectSubjectDTO;
import com.mall.member.excel.MemberCollectSubjectExcel;
...
public class MemberCollectSubjectController {
    ...
    @RequiresPermissions("membercollectsubject:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("membercollectsubject:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("membercollectsubject:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("membercollectsubject:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("membercollectsubject:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("membercollectsubject:export")
