...
import com.mall.member.dto.MemberCollectSpuDTO;
import com.mall.member.excel.MemberCollectSpuExcel;
...
public class MemberCollectSpuController {
    ...
    @RequiresPermissions("membercollectspu:page")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("membercollectspu:export")
