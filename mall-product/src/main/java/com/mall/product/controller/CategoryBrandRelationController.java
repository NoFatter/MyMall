...
import com.mall.product.excel.CategoryBrandRelationExcel;
...
public class CategoryBrandRelationController {
    ...
    @RequiresPermissions("categorybrandrelation:page")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("categorybrandrelation:export")
